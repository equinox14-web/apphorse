...
import { isWhitelistedTester } from '../../utils/permissions';
...
const SignUp = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const isTester = isWhitelistedTester(email);
            ...
            if (isTester) {
                ...
                localStorage.setItem('userType', 'Pro'); // CRITICAL: Required by MainLayout onboarding check
                ...
                localStorage.setItem('userType', 'rider'); // CRITICAL: Required by MainLayout onboarding check
            }
            ...
            <Card className="animate-fade-in" style={{ width: '100%', maxWidth: '400px', padding: '2.5rem' }}>
                ...
                <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                    ...
                    <Button
                        ...
                        disabled={loading}
                    >
                        {loading ? t('settings_page.subscription.loading') : "S'inscrire"}
                    </Button>
                </form>
