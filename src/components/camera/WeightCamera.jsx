...
function WeightCamera({ horse, onWeightEstimated, onClose }) {
    ...
    const startDetection = () => {
        ...
        detectionIntervalRef.current = setInterval(async () => {
            ...
            // Vérifier que la vidéo a des dimensions valides avant la détection
            const video = videoRef.current;
            if (!video.videoWidth || !video.videoHeight || video.videoWidth === 0 || video.videoHeight === 0) {
                console.log('⏳ En attente du chargement de la vidéo...');
                return; // Skip this iteration, wait for valid dimensions
            }
